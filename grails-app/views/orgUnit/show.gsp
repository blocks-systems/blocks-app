...
<html>
    ...
    <body>
        ...
        <div id="show-orgUnit" class="content scaffold-show" role="main">
            ...
            <f:display bean="orgUnit" />
            <g:form resource="${this.orgUnit}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.orgUnit}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
